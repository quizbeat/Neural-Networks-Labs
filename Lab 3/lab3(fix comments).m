...
%{
% gradientn spusk s adaptivnym shagom i momentom
...
%{
% metod gibkogo rasprostraneniya
...
%
% Levenberga-Markvadta
net = feedforwardnet(5, 'trainlm');
%}

%{
% odnoshagoviy medod sekushih
